...
ikb_menu = InlineKeyboardMarkup(row_width=4, inline_keyboard=inline_keyboard)
ikb_menu_with_skip = InlineKeyboardMarkup(row_width=4, inline_keyboard=inline_keyboard_with_skip)
